...
export const ErrorApiCatch = {
  ...
  Error_Connect_AlreadyConnected: {
    code: 4032,
    message: '连接错误：已经连接或正在连接'
  },
  ...
  Error_Read_NotSupport: {
    code: 4052,
    message: '读特征值错误：当前特征不支持读操作'
  },
  Error_Read_NoService: {
    code: 4053,
    message: '读特征值错误：没有找到指定服务'
  },
  Error_Read_NoCharacteristic: {
    code: 4054,
    message: '读特征值错误：没有找到指定特征值'
  },
  // Api: write
  Error_Write_Failed: { code: 4060, message: '写入数据错误：写入数据失败' },
  Error_Write_NotConnected: { code: 4061, message: '写入数据错误：蓝牙未连接' },
  Error_Write_NotSupport: {
    code: 4062,
    message: '写入数据错误：当前特征不支持写操作'
  },
  Error_Write_NoService: {
    code: 4063,
    message: '写入数据错误：没有找到指定服务'
  },
  Error_Write_NoCharacteristic: {
    code: 4064,
    message: '写入数据错误：没有找到指定特征值'
  },
  // Api: notify
  Error_Notify_Failed: {
    code: 4070,
    message: '监听特征值错误：监听特征值错误失败'
  },
  Error_Notify_NotConnected: {
    code: 4071,
    message: '监听特征值错误：蓝牙未连接'
  },
  Error_Notify_NotSupport: {
    code: 4072,
    message: '监听特征值错误：当前特征不支持监听操作'
  },
  Error_Notify_NoService: {
    code: 4073,
    message: '监听特征值错误：没有找到指定服务'
  },
  Error_Notify_NoCharacteristic: {
    code: 4074,
    message: '监听特征值错误：没有找到指定特征值'
  }
}

...
export class BTManager {
  ...
  registerDidUpdateConnectStatus(cb) {
    if (typeof cb !== 'function')
      throw new TypeError('connectStatus callback expect function')
  ...
  registerDidDiscoverDevice(cb) {
    if (typeof cb !== 'function')
      throw new TypeError('discoverDevice callback expect function')
  ...
  registerDidUpdateValueForCharacteristic(cb) {
    if (typeof cb !== 'function')
      throw new TypeError(
        'updateValueForCharacteristic callback expect function'
      )
